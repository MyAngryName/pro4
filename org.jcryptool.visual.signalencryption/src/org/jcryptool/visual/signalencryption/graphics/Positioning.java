...
public class Positioning {
	...
	/**
	 * Specifies a Point on the given control. Those can resolve to X or Y coordinates independently.
	 * <pre>
	 *                   North
	 *                     |
	 *                     ˇ
	...
	public static class Anchor {
		...
		/**
		 * Resolve the absolute point of this anchor on the given canvas.
		 * In-between parents are automatically traversed and added.
		 */
		...
		/**
		 * Resolve the absolute point of this anchor plus the given offsets on the given canvas
		 * In-between parents are automatically traversed and added.
		 */
	...
	public static enum Side {
		...
		/**
		 * There is a problem with groups that they don't put their proper location into getBounds().
		 * This constants acknowledges that we are using exactly two groups.
		 * 
		...
		public static Rectangle correctedBounds(Control control, Control drawingCanvas) {
			...
			return new Rectangle(
					innerBounds.x + offsetX,
					innerBounds.y + offsetY,
					innerBounds.width,
					innerBounds.height
			);
		}
