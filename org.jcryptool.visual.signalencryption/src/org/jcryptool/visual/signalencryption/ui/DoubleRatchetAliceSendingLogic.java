    ...
    public enum AliceSendingStep implements DoubleRatchetStep {
        ...
        STEP_1 {
            ...
            protected void switchState(DoubleRatchetView swtParent) {
                ...
                aliceContent.txt_aliceCipherText
        ...
        STEP_4 {
            ...
            public DoubleRatchetStep back(DoubleRatchetView swtParent) {
                ...
                if (AlgorithmState.get().allowMessageEntering()) {
                    var currentInput = swtParent.getAliceSendingContent().txt_alicePlainText
                            .getText();
        ...
        /**
         * Showing the final, encrypted message and "send" it to Bob.
         * Showing Alice's view (important if going backwards).
         */
        STEP_5 {
        ...
        /**
         * Switch to Bob's view and "receive" the encrypted message.
        ...
        STEP_6 {
            ...
            protected void switchState(DoubleRatchetView swtParent) {
                ...
                // Initial value only valid for initial message
                if (AlgorithmState.get().getCommunication().isBeginning()) {
                    bobContent.txt_bobReceivingStep0
                            .setText(Messages.SignalEncryption_bobDescriptionText0);
                } else {
                    bobContent.txt_bobReceivingStep0
                            .setText("Bob wartet auf eine Nachricht von Alice");
                }
            }
