...
public class SessionCipher {
     ...
     */
    public EncryptCallbackHandler encrypt(JCrypToolCapturer capturer) {
    ...
    private MessageKeys getOrCreateMessageKeys(SessionState sessionState,
                                               ...
                                               ChainKey chainKey, int counter, JCrypToolCapturer capturer)
    ...
    public class EncryptCallbackHandler {
        ...
        private ChainKey nextChainKey;

        EncryptCallbackHandler(
            ...
            this.SESSION_LOCK = SESSION_LOCK;
            this.nextChainKey = nextChainKey;
        }

        public CiphertextMessage doEncrypt(byte[] paddedMessage) throws UntrustedIdentityException {
            synchronized (SESSION_LOCK) {
